# Ausleihfunktion- Frontend Code

This directory contains the frontend code for the Ausleihfunktion plugin.
...
This will compile the frontend into the `../ausleihfunktion/static` directory (ready for distribution).
